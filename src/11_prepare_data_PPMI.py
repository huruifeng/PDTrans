...
expr_df = pd.read_csv("../results/processed/sample_expr_ppmi.csv", index_col=0, header=0)
meta_df = pd.read_csv("../results/processed/sample_meta_ppmi.csv", index_col=0, header=0)
...
patient_visit_df = pd.read_csv("../results/processed/PPMI_patient_visits.csv", index_col=0, header=0)
...
visit_month = {"visit_m0":0,"visit_m6":6,"visit_m12":12,"visit_m24":24,"visit_m36":36}
...
df.to_csv("../results/training_testing/UPDRS123Sum/PPMI_data_current_next.csv",index=True)
...
## PPMI viits: m0, m12 -> m24, m12, m24 -> m36
...
patient_visit_df_m0.columns = ["visit_m0","visit_m12","visit_m24"]

patient_visit_df_m12 = patient_visit_df.loc[:,["visit_m12","visit_m24","visit_m36"]]
patient_visit_df_m12 = patient_visit_df_m12.dropna(axis=0)
...
patient_record = patient_visit_df_m12.to_dict(orient="index")
for patient in patient_record.keys():
    patient_visit_ls.append(patient_record[patient].items())
...
df.to_csv("../results/training_testing/UPDRS123Sum/PPMI_data_previous_current_next.csv", index=True)
